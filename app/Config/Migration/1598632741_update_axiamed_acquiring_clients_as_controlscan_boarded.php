<?php
class UpdateAxiamedAcquiringClientsAsControlscanBoarded extends CakeMigration {
 ...
 * @var string
 */
	public $description = 'update_axiamed_acquiring_clients_as_controlscan_boarded';
 ...
 */
	public function after($direction) {
		...
		if ($direction === 'up') {
			...
			$row = 1;
			if (($handle = fopen($dir . "boardedInControlScan.csv", "r")) !== false) {
